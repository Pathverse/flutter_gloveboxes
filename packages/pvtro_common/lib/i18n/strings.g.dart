...
///
/// Locales: 13
/// Strings: 2158 (166 per locale)
///
/// Built on 2025-10-07 at 20:10 UTC
...
/// Translation happens during initialization of the widget (call of pvtroCommon).
/// Configurable via 'translate_var'.
///
/// Usage:
/// String a = pvtroCommon.someKey.anotherKey;
/// String b = pvtroCommon['someKey.anotherKey']; // Only for edge cases!
Translations get pvtroCommon => LocaleSettings.instance.currentTranslations;
...
///
/// Step 2:
/// final pvtroCommon = Translations.of(context); // Get pvtroCommon variable.
/// String a = pvtroCommon.someKey.anotherKey; // Use pvtroCommon variable.
/// String b = pvtroCommon['someKey.anotherKey']; // Only for edge cases!
...
/// context.pvtroCommon.someKey.anotherKey
extension BuildContextTranslationsExtension on BuildContext {
	Translations get pvtroCommon => TranslationProvider.of(this).translations;
}

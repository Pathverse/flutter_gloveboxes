...
class TranslationsNo extends Translations {
	...
	@override late final TranslationsRanksNo ranks = TranslationsRanksNo._(_root);
	@override late final TranslationsPriorityNo priority = TranslationsPriorityNo._(_root);
	@override late final TranslationsTimeNo time = TranslationsTimeNo._(_root);
	@override late final TranslationsTimeRelativeNo timeRelative = TranslationsTimeRelativeNo._(_root);
	@override late final TranslationsDayNo day = TranslationsDayNo._(_root);
	@override late final TranslationsDayTypeNo dayType = TranslationsDayTypeNo._(_root);
	@override late final TranslationsDayRelativeNo dayRelative = TranslationsDayRelativeNo._(_root);
	@override late final TranslationsLanguageNo language = TranslationsLanguageNo._(_root);
	@override late final TranslationsLanguageShortNo languageShort = TranslationsLanguageShortNo._(_root);
	@override late final TranslationsButtonsNo buttons = TranslationsButtonsNo._(_root);
	@override late final TranslationsLabelsNo labels = TranslationsLabelsNo._(_root);
	@override late final TranslationsResponseNo response = TranslationsResponseNo._(_root);
	@override late final TranslationsCommonWebFeaturesNo commonWebFeatures = TranslationsCommonWebFeaturesNo._(_root);
}
...
// Path: ranks
class TranslationsRanksNo extends TranslationsRanksEn {
	TranslationsRanksNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: priority
class TranslationsPriorityNo extends TranslationsPriorityEn {
	TranslationsPriorityNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: time
class TranslationsTimeNo extends TranslationsTimeEn {
	TranslationsTimeNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: timeRelative
class TranslationsTimeRelativeNo extends TranslationsTimeRelativeEn {
	TranslationsTimeRelativeNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: day
class TranslationsDayNo extends TranslationsDayEn {
	TranslationsDayNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: dayType
class TranslationsDayTypeNo extends TranslationsDayTypeEn {
	TranslationsDayTypeNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: dayRelative
class TranslationsDayRelativeNo extends TranslationsDayRelativeEn {
	TranslationsDayRelativeNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: language
class TranslationsLanguageNo extends TranslationsLanguageEn {
	TranslationsLanguageNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: languageShort
class TranslationsLanguageShortNo extends TranslationsLanguageShortEn {
	TranslationsLanguageShortNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: buttons
class TranslationsButtonsNo extends TranslationsButtonsEn {
	TranslationsButtonsNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: labels
class TranslationsLabelsNo extends TranslationsLabelsEn {
	TranslationsLabelsNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
// Path: response
class TranslationsResponseNo extends TranslationsResponseEn {
	TranslationsResponseNo._(TranslationsNo root) : this._root = root, super.internal(root);
...
class TranslationsCommonWebFeaturesNo extends TranslationsCommonWebFeaturesEn {
	TranslationsCommonWebFeaturesNo._(TranslationsNo root) : this._root = root, super.internal(root);

...
class TranslationsNo extends Translations {
	...
	@override late final TranslationsLanguagesNo languages = TranslationsLanguagesNo._(_root);
}
...
// Path: languages
class TranslationsLanguagesNo extends TranslationsLanguagesEn {
	TranslationsLanguagesNo._(TranslationsNo root) : this._root = root, super.internal(root);

	final TranslationsNo _root; // ignore: unused_field

	// Translations
	@override late final TranslationsLanguagesCurrentNo current = TranslationsLanguagesCurrentNo._(_root);
}
...
class TranslationsLanguagesCurrentNo extends TranslationsLanguagesCurrentEn {
	TranslationsLanguagesCurrentNo._(TranslationsNo root) : this._root = root, super.internal(root);
	...
	@override String get zhHans => 'Kinesisk (Forenkla)';
...
extension on TranslationsNo {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'languages.current.zhHans': return 'Kinesisk (Forenkla)';

...
class TranslationsNb extends Translations {
	...
	@override late final TranslationsLengthNb length = TranslationsLengthNb._(_root);
	@override late final TranslationsLengthUsNb lengthUs = TranslationsLengthUsNb._(_root);
	@override late final TranslationsLengthPluralNb lengthPlural = TranslationsLengthPluralNb._(_root);
	@override late final TranslationsWeightNb weight = TranslationsWeightNb._(_root);
	@override late final TranslationsWeightUsNb weightUs = TranslationsWeightUsNb._(_root);
	@override late final TranslationsWeightPluralNb weightPlural = TranslationsWeightPluralNb._(_root);
	@override late final TranslationsVolumeNb volume = TranslationsVolumeNb._(_root);
	@override late final TranslationsVolumeUsNb volumeUs = TranslationsVolumeUsNb._(_root);
	@override late final TranslationsSpeedNb speed = TranslationsSpeedNb._(_root);
	@override late final TranslationsTemperatureNb temperature = TranslationsTemperatureNb._(_root);
	@override late final TranslationsDigitalNb digital = TranslationsDigitalNb._(_root);
	@override late final TranslationsNetworkSpeedNb networkSpeed = TranslationsNetworkSpeedNb._(_root);
}
...
// Path: length
class TranslationsLengthNb extends TranslationsLengthEn {
	TranslationsLengthNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: lengthUs
class TranslationsLengthUsNb extends TranslationsLengthUsEn {
	TranslationsLengthUsNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: lengthPlural
class TranslationsLengthPluralNb extends TranslationsLengthPluralEn {
	TranslationsLengthPluralNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: weight
class TranslationsWeightNb extends TranslationsWeightEn {
	TranslationsWeightNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: weightUs
class TranslationsWeightUsNb extends TranslationsWeightUsEn {
	TranslationsWeightUsNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: weightPlural
class TranslationsWeightPluralNb extends TranslationsWeightPluralEn {
	TranslationsWeightPluralNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: volume
class TranslationsVolumeNb extends TranslationsVolumeEn {
	TranslationsVolumeNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: volumeUs
class TranslationsVolumeUsNb extends TranslationsVolumeUsEn {
	TranslationsVolumeUsNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: speed
class TranslationsSpeedNb extends TranslationsSpeedEn {
	TranslationsSpeedNb._(TranslationsNb root) : this._root = root, super.internal(root);

	final TranslationsNb _root; // ignore: unused_field

	// Translations
	@override String get kph => 'Kilometer per time';
	@override String get mph => 'Miles per time';
}

// Path: temperature
class TranslationsTemperatureNb extends TranslationsTemperatureEn {
	TranslationsTemperatureNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: digital
class TranslationsDigitalNb extends TranslationsDigitalEn {
	TranslationsDigitalNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
// Path: networkSpeed
class TranslationsNetworkSpeedNb extends TranslationsNetworkSpeedEn {
	TranslationsNetworkSpeedNb._(TranslationsNb root) : this._root = root, super.internal(root);
...
extension on TranslationsNb {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'speed.mph': return 'Miles per time';
